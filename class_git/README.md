...
```sh
..wd  #Vemos la ruta de la carpeta en la que estamos
...
git rm #elimina los archivos, pero no su historial. Si queremos recuperar algo, solo hay queregresar. se utiliza así:
